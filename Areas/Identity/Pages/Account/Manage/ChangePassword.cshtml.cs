...
namespace Cascade.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            var hasPassword = await _userManager.HasPasswordAsync(Aq3Zh4Service);
            if (!hasPassword)
            {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var changePasswordResult = await _userManager.ChangePasswordAsync(Aq3Zh4Service, Input.OldPassword, Input.NewPassword);
            ...
            _logger.LogInformation("Aq3Zh4Service changed their password successfully.");
